...
for sheet_name in sheet_names:
    ...
    save_path = f'Z:/ra/uhn/blad/Meeting - Aug 16th/figures/roc_curves_best_Lasso/{sheet_name}_Best_ROC_curve.tif'
...
# Save the plot to the specified path
save_path = f'Z:/ra/uhn/blad/Meeting - Aug 16th/figures/roc_curves_best_Lasso/{selected_sheet}_{selected_model}_ROC_curve.tif'
plt.savefig(save_path, format='tif', bbox_inches='tight')