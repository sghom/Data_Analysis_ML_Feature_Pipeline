...
sheet_name = 'Clinical_PFT_Osc_qCT'
...
print("\nUpdated Covariates List and their VIF after removing high VIF variables:")
...
plt.title('BLAD Status - ROC Curve', fontproperties=font_prop, fontsize=18, fontweight='bold')
